...
echo rsync -zarv --exclude ".*/" --include="*/" --include="*.yaml" --exclude="*" "${GITHUB_WORKSPACE}/${source}" "${temp}"
rsync -zarv --exclude ".*/" --include="*/" --include="*.yaml" --exclude="*" "${GITHUB_WORKSPACE}/${source}" "${temp}"
